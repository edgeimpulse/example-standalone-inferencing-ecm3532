...
{
#ifdef EXACT_STACK
    (void (*)(void))((uint32_t)EXACT_STACK),
#else
...
/***************************************************************************//**
 *
 * Default_Fault_Handler - Fault ISR handler.
 *
 ******************************************************************************/
void
...
/***************************************************************************//**
 *
 * Default_Reset_Handler - Default Reset ISR handler.
 *
 ******************************************************************************/
...
Default_Reset_Handler(void)
{
    ...
    //
    // If a cold start, zero fill the bss.
    //
    if(!REG_RTC_AO_CSR.BF.WARM_START_MODE)
    {
        //
        // Variable indicating if the this is in flash.
        //
        bRunningInFlash =
