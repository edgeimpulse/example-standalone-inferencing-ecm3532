...
#define CONFIG_DSP_HELLO_WORLD 1
#define CONFIG_DSP_FW "hello_world"
...
#define CONFIG_MONO_LEFT 1
#define CONFIG_CHAN_MODE 1
#define CONFIG_15MS 1
#define CONFIG_MS_FRAME_LENGTH 15
#define CONFIG_BUF_CNT 250
