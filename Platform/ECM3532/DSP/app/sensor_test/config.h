...
#define CONFIG_DSP_SENSOR 1
#define CONFIG_DSP_FW "sensor_test"
#define CONFIG_SENSOR_MANAGER 1
#define CONFIG_SENSOR_DEV_COUNT 5
#define CONFIG_SENSOR_TIMESTAMP 1
#define CONFIG_LSM6DSL_DSP 1
#define CONFIG_LSM6DSL_DSP_NAME "lsm6dsl_dsp"
#define CONFIG_BATCH_TEST 1
#define CONFIG_SAMPLE_COUNT 100
#define CONFIG_FLUSH_AFTER_BATCH_COUNT 0
#define CONFIG_XL_ODR 50
#define CONFIG_GYRO_ODR 25
