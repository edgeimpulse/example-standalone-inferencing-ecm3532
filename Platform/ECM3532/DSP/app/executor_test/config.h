...
#define CONFIG_DSP_FW "executor_test"
#define CONFIG_EXECUTOR 1
#define CONFIG_DSP_UNIT_TEST "row36"
#define CONFIG_OP_M3_CONV2D_Q7 1
#define CONFIG_OP_M3_AVPOOL2D_Q7 1
#define CONFIG_OP_M3_RELU_Q7 1
#define CONFIG_OP_M3_PW_CONV2D_Q7 1
#define CONFIG_OP_M3_DS_CONV2D_Q7 1
#define CONFIG_OP_DSP_CHW_2X2_CONV2D_RELU_AVGPOOL_Q7 1
#define CONFIG_OP_DSP_CHW_3X3_CONV2D_RELU_AVGPOOL_Q7 1
#define CONFIG_OP_DSP_CHW_PW_CONV2D_Q7 1
#define CONFIG_OP_DSP_HWC_PW_CONV2D_Q7 1
#define CONFIG_OP_DSP_HWC_PW_CONV2D_Q7_FAST 1
#define CONFIG_OP_DSP_CHW_3X3_CONV2D_STRIDE2_PAD0_RELU 1
#define CONFIG_OP_DSP_CHW_3X3_CONV2D_STRIDE1_PAD0_RELU 1
#define CONFIG_OP_DSP_CHW_2X2_CONV2D_STRIDE2_PAD0_RELU 1
#define CONFIG_OP_DSP_DS_CHW_2X2_CONV2D_STRIDE2_PAD0_RELU 1
#define CONFIG_OP_DSP_DS_CHW_3X3_CONV2D_STRIDE2_PAD0_RELU 1
#define CONFIG_OP_DSP_DS_CHW_3X3_CONV2D_STRIDE1_PAD0_RELU 1
#define CONFIG_APP_LED 1
#define CONFIG_APP_LED_GPIO 1
#define CONFIG_APP_NAME "executor_cifar10"
#define CONFIG_SW_VERSION "TensaiFlow_rc_alpha-0.1"
#define CONFIG_SW_VERSION_EXTRA "181-ge2379336"
