...
/***************************************************************************//**
 *
 * EtaBspLedsSet - Set multiple LEDs
 *
 * @param ui8Leds LEDs to set. e.g. Bit0 - LED0, Bit1 - LED1, etc.
 *
 ******************************************************************************/
void
EtaBspLedsSet(uint8_t ui8Leds)
{
#if ETA_BSP_LED_POLARITY_LOW_IS_ON
    REG_GPIO_DATA_OUT_CLR.V = (((ui8Leds & 0x1) << ETA_BSP_LED0) |
                               (((ui8Leds & 0x2) >> 1) << ETA_BSP_LED1) |
                               (((ui8Leds & 0x4) >> 2) << ETA_BSP_LED2) |
                               (((ui8Leds & 0x8) >> 3) << ETA_BSP_LED3));
#else
    REG_GPIO_DATA_OUT_SET.V = (((ui8Leds & 0x1) << ETA_BSP_LED0) |
                               (((ui8Leds & 0x2) >> 1) << ETA_BSP_LED1) |
                               (((ui8Leds & 0x4) >> 2) << ETA_BSP_LED2) |
                               (((ui8Leds & 0x8) >> 3) << ETA_BSP_LED3));
#endif
...
/***************************************************************************//**
 *
 * EtaBspLedsClear - Clear multiple LEDs
 *
 * @param ui8Leds LEDs to clear. e.g. Bit0 - LED0, Bit1 - LED1, etc.
 *
 ******************************************************************************/
void
EtaBspLedsClear(uint8_t ui8Leds)
{
#if ETA_BSP_LED_POLARITY_LOW_IS_ON
    REG_GPIO_DATA_OUT_SET.V = (((ui8Leds & 0x1) << ETA_BSP_LED0) |
                               (((ui8Leds & 0x2) >> 1) << ETA_BSP_LED1) |
